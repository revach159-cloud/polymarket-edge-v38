# Deep Research — Medallion-Style Short-Horizon Statistical Prediction (Public Characterization)

- Strategy ID: `strat_medallion_style_stat_arb`
- Evidence: STRONGLY_SUPPORTED
- Edge score: 92
- Quality: 88
- Reproducibility: 8
- Regime dependency: 40
